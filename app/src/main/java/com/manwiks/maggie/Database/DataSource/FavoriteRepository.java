...
public class FavoriteRepository implements mFavoriteDataSource {

    private mFavoriteDataSource favoriteDataSource;

    public FavoriteRepository(mFavoriteDataSource favoriteDataSource) {
        this.favoriteDataSource = favoriteDataSource;
    }

    private static FavoriteRepository instance;
    public  static FavoriteRepository getInstance(mFavoriteDataSource favoriteDataSource){
        if(instance == null)
